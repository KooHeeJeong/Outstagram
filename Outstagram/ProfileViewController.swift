...
final class ProfileViewController : UIViewController {
    ...
    private lazy var follwButton: UIButton = {
        let button = UIButton()
...
private extension ProfileViewController {
    ...
    func setupLayout(){
        let buttonStackView = UIStackView(arrangedSubviews: [follwButton,messageButton])
